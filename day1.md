...
クラウドを手軽に試してみる一番簡単な方法は仮想化ソフト上でkvmの
ホストサーバのような仮想化ソフトを動かしてみる事です．つまり
Nested VMです．VMwareでそれが可能だと知ったのがこの本で書いている
構成を試し始めたきっかけです．
...
これで最低限の環境が整いました．WARNINGがでていますが，まだ原因を
つかめていません．動いているのでとりあえず気にしないでいます．それでは
rebootしておきましょう．
...
VMWare Fusionを使うとmac上でkvmが動くCentOSを構築することが可能です．
そのためにはあまり知られていない設定ファイルを修正する必要があります．
他の仮想化ソフトでも同様の機能があるかどうかを調べてみたのですが
見つける事ができませんでした．
